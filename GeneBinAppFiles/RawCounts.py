...
def app(datadir, rep, cond):
    ...
    st.title("Run Noise Fits")

    st.text("""This will run the fitting algorithm on high count
genes to estimate the noise parameters.""")
    ...
    if st.button("Fit Noise: This will take a while"):
        script_path = "./GeneBinScripts/FitNoiseParameters.jl"  # Replace with the actual path to your Julia script
