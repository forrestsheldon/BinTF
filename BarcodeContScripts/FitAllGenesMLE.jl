...
for BC in BClist
    ...
    try
        if contdist == "Full"
            ...
            ρμi, fi = MoMFullfμ(BCcountdict, ν, γ, α)
            ...
            fitresults = fitgene_MLE_Full_fμ(BCcountdict, ν, γ, α, lower, upper, initial)
        ...
        elseif contdist == "Poisson"
            ...
            ρμi, fi = MoMPoissonfμ(BCcountdict, λ, α)
            # [λ, ρμ, α, f]
            lower = [0., 0.]
            upper = [1e3, 1.]
            initial = [ρμi, fi]

            fitresults = fitgene_MLE_Poisson_fμ(BCcountdict, λ, α, lower, upper, initial)
            ρμ, f = fitresults.minimizer
