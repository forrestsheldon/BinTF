...
begin
	pre1celldf = DataFrame(CSV.File(joinpath("./Data/PreAmp_R01R02/PreAmp_R01_CellCounts.tsv"), delim="\t"))
	pre1noBCcells = parse(Int, readline("./Data/PreAmp_R01R02/PreAmp_R01_noBCcells.txt"))
	pre1finalcelldf = DataFrame(CSV.File("./Data/PreAmp_R01R02/PreAmp_R01_Labeled.tsv", delim="\t"))
	
	pre2celldf = DataFrame(CSV.File(joinpath("./Data/PreAmp_R01R02/PreAmp_R02_CellCounts.tsv"), delim="\t"))
	pre2noBCcells = parse(Int, readline("./Data/PreAmp_R01R02/PreAmp_R02_noBCcells.txt"))
	pre2finalcelldf = DataFrame(CSV.File("./Data/PreAmp_R01R02/PreAmp_R02_Labeled.tsv", delim="\t"))
